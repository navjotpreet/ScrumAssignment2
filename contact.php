...
<!-- End Navbar -->
					...
					<textarea rows="4" name="message" id="message"></textarea>
						...
						<div class="alert alert-success successBox" id="successbox" style="width: 90%; margin-left: 30px;">
				<button type="button" class="close" onclick="showMsg(1);">×</button>
				<strong style="font-size: 16px;">Congratulations!</strong><span class="alert-link"> Your Form has been submitted!</span>
				</div>

					<footer>
					<button type="submit" class="btn-u" name="formsub">Submit</button>
					</footer>
...
<div class="col-12">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3488577.0694117756!2d74.9231632430266!3d31.364124121944418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a071d0ee39f121%3A0x8764f3fe2b0462fb!2sUnity%20Hospital!5e0!3m2!1sen!2sin!4v1683270069236!5m2!1sen!2sin" style="width:100%;" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
...
$sql = "INSERT INTO tb_hm (name, email, phone, message)
